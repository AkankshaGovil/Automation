...
class ExecutionEngine:
    ...
    def __init__(self,
        ...
        self.watcher  = None                                                                 
        self.watcher_bkup = None                                                             
        # 43909 - Added flag for reverting back the original /etc/hosts file                 
        self.revertBack = False                                                              
                                                                                      
        # 39583 - Variable which indicates whether the test case restarts the iserver        
        self.msw_restart = False   
