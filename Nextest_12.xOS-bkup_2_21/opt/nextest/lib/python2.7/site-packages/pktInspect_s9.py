...
class Endpoint(PacketCollection):
  ...
  def __init__(self, packets,includertp=False):
    ...
    self.packets = packets
    # S9: Added next two lines
    if len(self.packets) > 0:
        self.packets = self.discardDuplicatePackets()
  ...
  # S9 : Following function is added
  def discardDuplicatePackets(self):
    """
      This function is added for S9 setup. On S9 setup, there are duplicate packets. This fuction will discard the duplicate packets.
    """
    ...
    for packet in self.packets:
       if stat:
           dupPacketList.append(packet)
           stat = False
       else:
           stat = True

    return dupPacketList
...
class utCaptures(unittest.TestCase):
   ...
   def test8(self):
       ...
       a= readCapture("/var/opt/nextest/tdb/results/20091013_0813/production_components-radius-siprad_019_pkttrace_g0_g1.pdml")
       a.printEndpoints()
