...
TAVL_treeptr tavl_init(int (*compare)(const void *key1, const void *key2,void *Param),
                    int  (*Inscompare)(const void *DataObject1,const void *DataObject2,void *param),
...
void* tavl_delete(TAVL_treeptr tree, void *key , TAVL_nodeptr ret);
            /*
	    ...
	    Editing, Tavl frees the data, where as we require data not to be freed.
	    Changing signature for delete function.
	    It should return data pointer in case node is found and deleted, else should return null.
	    */
...
typedef struct tavltree {
            ...
            int (*Inscompare)(const void *,const void *,void *);
