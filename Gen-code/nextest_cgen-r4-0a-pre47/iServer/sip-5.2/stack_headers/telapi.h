...
** Parameters:
**		pUrl (IN)		- TelUrl								
**		pGlobal (OUT)	- retrieved global number
**		pErr (OUT)		- Possible Error value (see API ref doc)
************************************************************************/
extern SipBool sip_getGlobalNumFromTelUrl _ARGS_((TelUrl *pUrl, \
...
** Parameters:
**		pUrl (IN)		- TelUrl								
**		pLocal (OUT)	- retrieved local number
**		pErr (OUT)		- Possible Error value (see API ref doc)
************************************************************************/
extern SipBool sip_getLocalNumFromTelUrl _ARGS_ ((TelUrl *pUrl,\
	TelLocalNum *pLocal, SipError *pErr));
#endif
...
** Parameters:
**		pLocal (IN)		- TelLocalNum								
**		pParam (OUT)	- retrieved parameter
**		dIndex (IN)		- index at which parameter is to be retreived
**		pErr (OUT)		- Possible Error value (see API ref doc)
************************************************************************/
extern SipBool sip_getParamAtIndexFromTelLocalNum _ARGS_((TelLocalNum *local,\
...
******************************************************************************/
extern SipBool sip_getParamAtIndexFromTelGlobalNum _ARGS_ ((TelGlobalNum \
	*global, SipParam *pParam, SIP_U32bit dIndex, SipError *pErr));
#endif
