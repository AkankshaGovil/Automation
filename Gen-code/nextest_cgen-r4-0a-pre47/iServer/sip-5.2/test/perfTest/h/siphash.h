 ...
 */
typedef SIP_U32bit (*sip_hashFunc) (SIP_Pvoid pData);

/*
 * The function to be used to compare keys of 2 hash elements.
 */
typedef SIP_U8bit (*sip_hashKeyCompareFunc) (SIP_Pvoid pKey1,\
					SIP_Pvoid pKey2);
 ...
 */
typedef SIP_S32bit (*sip_hashIteratorFunc) (SIP_Pvoid pKey, SIP_Pvoid pElement);

/*
 * The function to free the data stored in the hash element.
 */
typedef void (*sip_hashElementFreeFunc) (SIP_Pvoid pElement);

/*
 * The function to free the key stored in the hash element.
 */
typedef void (*sip_hashKeyFreeFunc) (SIP_Pvoid pKey);
...
SIP_S8bit sip_hashAdd _ARGS_((SipHash *pHash, \
		SIP_Pvoid pElement, SIP_Pvoid pKey));
 ...
 **
 ******************************************************************************/
SIP_Pvoid sip_hashFetch _ARGS_((SipHash *pHash, \
								SIP_Pvoid pKey));
 ...
 **
 ******************************************************************************/
SIP_S8bit sip_hashRemove _ARGS_((SipHash *pHash, SIP_Pvoid pKey));
 ...
 **
 ** PARAMETERS:
 ** name(IN):		String for which to calculate the Hash Value
 ******************************************************************************/
SIP_U32bit sip_elfHash _ARGS_((SIP_Pvoid name));
/******************************************************************************
 ...
 **
 ** DESCRIPTION:	Frees the HashKey Element
 **
 ** PARAMETERS:
 ** pKey(IN):	pointer to the Key Element to be freed
 ******************************************************************************/
void sip_hashKeyFreeFunction (SIP_Pvoid pKey);

/******************************************************************************
 ** FUNCTION: sip_hashElementFreeFunction
 **
 ** DESCRIPTION:	Frees the HashElement
 **
 ** PARAMETERS:
 ** pElement(IN):	pointer to the Hash Element to be freed
 ******************************************************************************/
void sip_hashElementFreeFunction(SIP_Pvoid pElement);

/******************************************************************************
 ** FUNCTION: sip_stringKeyCompareFunction
 **
 ** DESCRIPTION:	Key Compare Function
 **
 ** PARAMETERS:
 ** pKey1(IN):	pointer to the Key Element
 ** pKey2(IN):	pointer to the Key Element
 ******************************************************************************/
SIP_U8bit sip_stringKeyCompareFunction(SIP_Pvoid pKey1, SIP_Pvoid pKey2);
/******************************************************************************
 ** FUNCTION: sip_timerElementFree
 **
 ** DESCRIPTION:	Timer Element free function
 **
 ** PARAMETERS:
 ** pElement(IN):	Element to be freed
 ******************************************************************************/
