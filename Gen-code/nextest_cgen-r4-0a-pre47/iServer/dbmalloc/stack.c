...
#ifndef lint
static char rcs_hdr[] = "$Id: stack.c,v 1.1 2002/07/04 12:53:10 agoyal Exp $";
#endif
			...
			int				line )
{
	...
	else
	{
		...
		while ((!(match = StackMatch(this, func, file, line))) && (this->beside != NULL))
			this = this->beside;
			...
			int				line )
{
	...
	if (cnt == alloccnt)
	{
		...
		data = (struct stack *) malloc((SIZETYPE) (alloccnt * sizeof(*data)));
