...
#ifndef lint
static char rcs_hdr[] = "$Id: malign.c,v 1.1 2002/07/04 12:53:10 agoyal Exp $";
#endif
...
struct mlist *
AlignedMakeSeg(	struct mlist *	mptr,
				SIZETYPE		align )
{
	struct mlist *newptr;
	SIZETYPE offset;
 ...
 */
SIZETYPE
AlignedOffset(	struct mlist *	mptr,
				SIZETYPE		align )
{
	SIZETYPE offset;
