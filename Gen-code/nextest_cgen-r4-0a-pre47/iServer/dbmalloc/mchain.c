 ...
 */
#ifndef lint
static char rcs_hdr[] = "$Id: mchain.c,v 1.1 2002/07/04 12:53:10 agoyal Exp $";
#endif
...
int
DBmalloc_chain_check(	CONST char *	file,
						int				line,
						int				todo )
{
	int rc;
	...
	rc = DBFmalloc_chain_check( "malloc_chain_check", file, line, todo );
...
int
DBFmalloc_chain_check(	CONST char *	func,
						CONST char *	file,
						int				line,
						int				todo )
{
